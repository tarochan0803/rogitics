...
function regulationTypeLabel(type) {
  switch (type) {
    ...
    case 'max_weight_rating': return '車両総重量区分';
    case 'payload_class_restriction': return '最大積載量区分';
    case 'max_axle_load': return '軸重制限';
    case 'max_length': return '長さ制限';
    case 'max_speed': return '速度制限';
    case 'min_speed': return '最低速度';
    case 'school_zone': return 'スクールゾーン';
    case 'hazmat_restriction': return '危険物積載車規制';
    case 'toll': return '有料道路';
    case 'barrier': return 'ゲート・車止め';
    case 'chain_required': return 'チェーン規制';
    case 'seasonal_restriction': return '工事・季節規制';
    case 'stop_control': return '一時停止';
    case 'parking_restriction': return '駐停車規制';
    case 'regulation_data_freshness': return '規制データ鮮度';
    case 'time_restriction': return '時間帯規制';
    case 'turn_restriction': return '右左折・転回規制';
